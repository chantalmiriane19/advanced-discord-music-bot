module.exports = {
  ...
  PREFIX: process.env.PREFIX || "Prefix of Bot",
  embed: {
    color: process.env.color || "#220f80",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "© 2025 | Advance Music Bot",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  links: {
    inviteURL:
      ...
      ``,
    DiscordServer: process.env.DiscordServer || `Discord Server URL Support`,
    VoteURL: process.env.VoteURL || `VoteUrl of Bot`,
